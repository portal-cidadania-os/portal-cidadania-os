    ...
    >
      ...
      {SLIDES.map((s, i) => (
        ...
        >
          ...
          {/* Gradiente lateral — funde com o fundo escuro do Hero pela esquerda */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#0a0a1a] via-[#0a0a1a]/50 to-transparent" />
