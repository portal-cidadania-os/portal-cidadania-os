          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 pt-1">
              <a
                ...
                className="w-8 h-8 rounded-full bg-black hover:bg-black/80 flex items-center justify-center transition-colors ring-2 ring-[#6B21A8]"
              >
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24" className="text-[#ffcc00]">
