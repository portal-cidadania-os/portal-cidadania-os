...
// Inspirado em: Associação NEO (escuro, colunas) + Atados (CTA card)
// ============================================================
...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#0f0f1a] text-white">
      {/* Fundo FUNDO.png animado */}
      <div className="absolute inset-0 pointer-events-none bg-movimento-suave opacity-[0.05]" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-extrabold text-base text-white">Portal Cidadania</span>
            </div>
            ...
            <div className="flex items-center gap-2 pt-1">
              ...
              >
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24" className="text-white/50">
          ...
          <div className="flex flex-col gap-3">
            <h4 className="text-white/50 text-[11px] font-bold uppercase tracking-widest mb-1">
              Plataforma
            </h4>
            {[
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="mt-3 pt-3 border-t border-white/5 flex flex-col gap-1">
              <span className="text-white/25 text-xs">[Endereço da associação]</span>
              <span className="text-white/25 text-xs">[Cidade - UF, CEP XX.XXX-XXX]</span>
              <a
                href="mailto:contato@[dominio].org.br"
                className="text-white/35 hover:text-white/60 text-xs transition-colors mt-1"
              >
      ...
      {/* ── Barra Legal ── */}
      <div className="relative z-10 border-t border-brand-amarelo/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="text-brand-amarelo/50 text-xs text-center sm:text-left">
